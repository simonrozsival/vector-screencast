...
\include{macros/htmlcssjs_syntax}
\usepackage{caption}
...
\include{preface}
\include{chapters/02_online_education}
\include{chapters/04_short_specification}
\include{chapters/05_choice_of_technologies}
\include{chapters/06_file_format}
\include{chapters/07_implementation}
\include{chapters/08_integration}
\include{chapters/10_user_documentation}
...
\chapwithtoc{Contents of the attached files}
@todo: description of the attached files - source code, demo project, PDF version of the thesis, generated API doc, example screencasts + their bitmap versions
